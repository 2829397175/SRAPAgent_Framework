import yaml
chat_prompt_default = yaml.safe_load(open("EconAgent/prompt/chat_prompt/chat_prompt.yaml"))
example_default = yaml.safe_load(open("EconAgent/prompt/chat_prompt/example.yaml"))
