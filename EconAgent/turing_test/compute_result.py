...
def compute_auc_choose_one(type_keys = ["4","3.5"]):
    ...
    for data_root in ["EconAgent/LLM_decision_test/11_26_data/denotes_save_response",
                      "EconAgent/LLM_decision_test/11_28_data/denotes_save_response"]:
    ...
    df_acc.to_csv("EconAgent/LLM_decision_test/acc_choose_one.csv")
...
if __name__ == "__main__":
    # data_dir="EconAgent\LLM_decision_test\denote\judge"
