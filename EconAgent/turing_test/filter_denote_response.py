...
def filter_save_response(data_dir = "EconAgent\LLM_decision_test\denote\judge"):
...
def filter_en_to_cn(type_data,
                    english_data_dir ="EconAgent\LLM_decision_test/filtered_response_data_simulated\en_ver",
                    chinese_data_dir ="EconAgent\LLM_decision_test\denote\save_response",
                    save_dir = "EconAgent\LLM_decision_test/filtered_response_data_simulated\cn_ver"):
...
def filter_chinese_to_en(type_data,
                         chinese_data_dir ="EconAgent\LLM_decision_test\denote\save_response",
                         english_data_dir ="EconAgent\LLM_decision_test\english_judge_data",
                         save_dir = "EconAgent\LLM_decision_test/filtered_response_data",
                         ):
...
def filter_same_answer(judge_keys =["robot_response_4_chinese",
    ...
    data_all =[]
    data_paths =[
        "EconAgent/LLM_decision_test/11_26_data/denotes_save_response/0.json",
        "EconAgent/LLM_decision_test/11_26_data/denotes_save_response/2.json",
        "EconAgent/LLM_decision_test/11_26_data/denotes_save_response/3.json",
        "EconAgent/LLM_decision_test/11_26_data/denotes_save_response/4.json",
        "EconAgent/LLM_decision_test/11_26_data/denotes_save_response/5.json",
        "EconAgent/LLM_decision_test/11_26_data/denotes_save_response/6.json",
        "EconAgent/LLM_decision_test/11_28_data/denotes_save_response/28_0.json",
        # "EconAgent/LLM_decision_test/11_28_data/denotes_save_response/28_0_ver2.json",
        "EconAgent/LLM_decision_test/11_28_data/denotes_save_response/28_1.json",
        "EconAgent/LLM_decision_test/11_28_data/denotes_save_response/28_2.json",
        ]
...
def filter_group_denote():
    all_path = "EconAgent/LLM_decision_test/filtered_response_data_simulated/finished_denote/group/all"
...
def append_index(data_dir = "EconAgent/LLM_decision_test/11_28_data/split_data"):
