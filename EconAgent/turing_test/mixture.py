...
human_label_root = "EconAgent/LLM_decision_test/data_label/result_labeled"
bot_root = "EconAgent/LLM_decision_test/data_bot"
...
with open("EconAgent/LLM_decision_test/test/saving_QA.json", 'w', encoding='utf-8') as file:
