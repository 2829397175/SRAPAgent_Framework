...
def concat_experiment_results(task_path = "EconAgent/tasks",
...
def get_ex_names_single_experiment(ex_setting = "PHA_51tenant_5community_28house",
    ...
    used_names = readinfo("EconAgent/experiments/PHA_51tenant_5community_28house/all/ex_used_names.json")
...
if __name__ == "__main__":
    # paths = [
    #         "EconAgent/tasks/PHA_51tenant_5community_28house/configs/ver1_nofilter_singlelist/result/1699431290.0382807",
    #         "EconAgent/tasks/PHA_51tenant_5community_28house/configs/ver2_nofilter_multilist_priority_7t_5h/result/1699435988.0701036"
    #         ]
