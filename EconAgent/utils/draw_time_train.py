...
def draw_train_time(log_root ="EconAgent/optimizer/logs"):
    
    
    log_files =[ "EconAgent/optimizer/logs",
                "EconAgent/optimizer/logs_fairness"]
    train_times_all = []
    samples_all = []
    maes_all = []
    ...
    plt.tight_layout()
    plt.savefig("EconAgent/optimizer/optimize_time.png")
