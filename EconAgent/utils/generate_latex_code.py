...
if __name__ == "__main__":
    # root_dir = "EconAgent/tasks/PHA_51tenant_5community_28house_new_priority_label/global_evaluation/visualize_priority_rating"
    root_dir = "EconAgent/tasks/PHA_51tenant_5community_28house_new_priority_label/global_evaluation/visualize_priority_rating_weights"
    root_dir = "/data/jiarui_ji/publicHousing/EconAgent/tasks/PHA_51tenant_5community_28house_new_priority_perpersonlabel/global_evaluation/visualize_priority_rating_weights"
