...
def generate_optimize_df(optimize_log_dir):
    ...
    base_matrix = pd.read_csv("LLM_PublicHouseAllocation/experiments/forgpt/optimize.csv",
                              index_col=0)
...
if __name__ == "__main__":
    # generate_optimize_df("LLM_PublicHouseAllocation/optimizer/logs/1703218764.1385152")
    
    """fairness"""
    # generate_optimize_df("LLM_PublicHouseAllocation/optimizer/logs/1704249275.8022254")

    # generate_optimize_df("LLM_PublicHouseAllocation/optimizer/logs/1704249344.8196857")
    
    
    generate_optimize_df("LLM_PublicHouseAllocation/optimizer/logs_fairness/1704684718.9230282")
    """satisfaction"""
    # generate_optimize_df("LLM_PublicHouseAllocation/optimizer/logs/1704196514.0865245")
    # generate_optimize_df("LLM_PublicHouseAllocation/optimizer/logs/1703290655.310023")
    generate_optimize_df("LLM_PublicHouseAllocation/optimizer/logs/1704367257.8943155")
