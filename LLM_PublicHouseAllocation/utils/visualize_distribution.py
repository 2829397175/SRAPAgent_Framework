...
def visualize_tenant_rating(global_rating_path,
                            ...
                            tenant_path:str ="LLM_PublicHouseAllocation/tasks/PHA_51tenant_5community_28house/data/tenant_51.json"):
...
def visualize_experiment_result(save_path = "LLM_PublicHouseAllocation/experiments/PHA_51tenant_5community_28house_new_priority_label/hongkong_case"):
    # change k
...
if __name__ =="__main__":
    ...
    task_path = f"LLM_PublicHouseAllocation/tasks/{ex_setting}"
    ...
    global_rating_path= f"LLM_PublicHouseAllocation/tasks/{ex_setting}/global_evaluation"
    ...
    #                         house_path = f"LLM_PublicHouseAllocation/tasks/{ex_setting}/data/house_28.json",
    #                         tenant_path =f"LLM_PublicHouseAllocation/tasks/{ex_setting}/data/tenant_51.json")
    
    
    # visualize_rating_for_house(tenant_path = "LLM_PublicHouseAllocation/tasks/PHA_51tenant_5community_28house_new_priority_label/data/tenant_51.json",
    #                            global_rating_path= "LLM_PublicHouseAllocation/tasks/PHA_51tenant_5community_28house_new_priority_label/global_evaluation/global_score_newver.json",
    #                            house_path="LLM_PublicHouseAllocation/tasks/PHA_51tenant_5community_28house_new_priority_label/data/house_28.json")
    
    visualize_rating_weights(tenant_path = "LLM_PublicHouseAllocation/tasks/PHA_51tenant_5community_28house_new_priority_perpersonlabel/data/tenant_51.json",
                               global_rating_path= "LLM_PublicHouseAllocation/tasks/PHA_51tenant_5community_28house_new_priority_perpersonlabel/global_evaluation/global_score_newver.json")
    
    # visualize_tenant_attrs_priority(tenant_path = "LLM_PublicHouseAllocation/tasks/PHA_51tenant_5community_28house_new_priority_perpersonlabel/data/tenant_51.json")
